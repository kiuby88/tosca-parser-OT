...
import eu.seaclouds.tosca.model.staticresources.StaticTOSCANamespaces;
...
@XmlSeeAlso({eu.seaclouds.tosca.model.TImplementationArtifacts.ImplementationArtifact.class})
public class TImplementationArtifact extends TExtensibleElements {
	 ...
	 * @param generatedName generated name should be unique and follow the rule: ownerName
